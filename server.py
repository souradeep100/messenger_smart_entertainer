...
FACEBOOK_TOKEN = 'EAAcQBQ0gissBABjOgQRZCpwZCYxFbBoZBnZCZC7adDgQ7GGvBHFcpnhkEw3irpmJ9kIjCMm9xorETi8LUZCBq0lHpOpG3ft9XyQm9WJUWxN3tc9TRwuBOpslP10Fcm3moEUGFD4Db5cxRmEchGjFXA3dyVHl8luBVd4QvZCh4B0OgZDZD'
bot = None

@app.route('/', methods=['GET'])
def verify():
    if request.args.get('hub.verify_token', '') == 'piku1985':
